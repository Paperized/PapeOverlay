...
namespace GameOverlay.PInvoke
{
    internal static class User32
    {
        ...
        public delegate bool GetCursorPosDelegate(out NativePoint ntPoint);

        public static readonly GetCursorPosDelegate GetCursorPos;
        ...
        static User32()
        {
            ...
            GetCursorPos = DynamicImport.Import<GetCursorPosDelegate>(library, "GetCursorPos");
