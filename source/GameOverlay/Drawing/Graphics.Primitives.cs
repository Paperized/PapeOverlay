...
namespace GameOverlay.Drawing
{
    ...
    public struct Rectangle
    {
        ...
        /// <param name="height">The height of the rectangle</param>
        /// <returns>The Rectangle this method creates.</returns>
        public static Rectangle CenteredRectangle(Point center, float width, float height)
        {
            float halfWidth = width / 2;
            float halfHeight = height / 2;
            return new Rectangle(center.X - halfWidth, center.Y - halfHeight, center.X + halfWidth, center.Y + halfHeight);
        }
        ...
        public void MultiplySize(Point size)
        {
            Right *= size.X;
            Bottom *= size.Y;
        }
